$(document).ready(function(){
  ...
  black[4].setAttribute('class','figure blackfigure king');
  ...
  white[4].setAttribute('class','figure whitefigure king');
